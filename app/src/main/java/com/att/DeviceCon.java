...
//
//public class DeviceCon extends Activity
//{
...
////	    SpeechUtility.createUtility(DeviceCon.this, param.toString());
//        super.onCreate(savedInstanceState);
//
//
//
//        //加入bugly
//        //CrashReport.initCrashReport(DeviceCon.this, getString(R.string.app_id), false);
//
//        setContentView(R.layout.swingcardatt);
...
//
//			 openCamera();
//		//	 VoiceBroadcast.ttsInit(DeviceCon.this);
//		} catch (Exception e) {
//
//		}
//
...
//    	cameraV = new CameraView(DeviceCon.this);
...
//		 //  VoiceBroadcast.ttsPlay(DeviceCon.this,strPlayName);
...
//			{
//				//TtsApp.playTts(strPlayName);
//			//	VoiceBroadcast.ttsPlay(DeviceCon.this,"无效卡");
...
//				{
//					//TtsApp.playTts(strPlayName);
//				//	VoiceBroadcast.ttsPlay(DeviceCon.this,voice);
